...
class TransmissionNotificationSegment(StatusMiscSegment):
    ...
    def render(self):
        ...
        COUNT_PREDICATES = {
            ...
            self.TransmissionSectionStatus.SEEDING: lambda torrent: torrent[
                "status"
            ]
            == t.TransmissionTorrentStatus.seed,
            self.TransmissionSectionStatus.PAUSED: lambda torrent: torrent[
                "status"
            ]
            ...
            != 1,
            self.TransmissionSectionStatus.CHECKING: lambda torrent: torrent[
                "status"
            ]
